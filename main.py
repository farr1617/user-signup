...
#Define blank field to help assist with username field
def is_blank(str):
    if str == []:
     return True

#Create app route for signup form, with method rqmt, then define validation for each field in the
#requestform(username, password, password confirmation and email)
...
#Add conditions for each field to standardize user inputs
